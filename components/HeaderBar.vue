    ...
    <div class="container">
      ...
      >
          <span class="hero__tagline">
            <span>{{ tagline }}</span>
            <button v-on:click="refreshTagline" class="hero__tagline-refresh">
...
export default {
  ...
  methods: {
    refreshTagline() {
      ...
      this.tagline = this.list[chosenNumber];
    }
  }
}
</script>
